...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2017 a las 03:06:08
...
INSERT INTO `detallestelas` (`iddetallesTelas`, `idTipo`, `idTela`, `idUniMedida`, `idInventario`, `idEstado`, `rendimiento`, `color`, `ancho`) VALUES
(1, 'T', 1, 3, 1, 1, 3.5, 'Blanca', 1.62),
(2, 'T', 2, 2, 2, 2, NULL, 'Rosado', 1.7),
(3, 'T', 3, 3, 3, 1, 3.2, 'Gris Jaspe', 1.65),
(4, 'T', 4, 2, 4, 1, NULL, 'Azul Oscuro', 1.58);
...
('1017137664', 'Robinson Gallego Alzate', 'pineda2110@hotmail.com', 'rgallegoa', 'fifa2010', 2),
